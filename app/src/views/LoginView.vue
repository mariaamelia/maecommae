<template>
    <div class="p-4 max-w-xl mx-auto">
      ...
      <!-- Mensagem de sucesso global (opcional) -->
      ...
      <form @submit.prevent="handleLogin" class="flex flex-col gap-4">
        ...
        <div>
          ...
          <div class="relative">
            ...
            >
              <!-- Ícone de olho según o estado da senha -->
              ...
              <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a10.05 10.05 0 012.147-3.392M6.29 6.29A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.542 7a9.953 9.953 0 01-1.257 2.043M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
        ...
        <div class="flex justify-center mt-6">
          <button type="submit" class="bg-[#E67E80] text-white px-6 py-2 rounded-md text-sm font-semibold hover:bg-[#d46567] transition-colors">
            Entrar
          </button>
        </div>
      </form>
  ...
  // Variável para controle da visualização da senha
  const showPassword = ref(false)
  
  // Função para enviar os dados de login via POST para a API
  const handleLogin = async () => {
  try {
    // Primeira requisição: garantir CSRF se necessário
    ...
    // Salva o nome da usuária no localStorage
  ...
  <style scoped>
  /* Você pode adicionar estilos personalizados conforme necessário */
  </style>
